...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(1, _("Create DataBase Table"), "", wx.ITEM_NORMAL)
        self.frame_1_menubar.Append(wxglade_tmp_menu,_("Create DataBase"))
    ...
    def __set_properties(self):
        self.SetTitle(_("DATABASE PROJECT"))
    ...
    def open_dialog1(self,event):
        wx.MessageBox("Python was created in the early 1990s by Guido van Rossum at Stichtin Mathematisch Centrum (CWI, see http://www.cwi.nl) in the Netherlandsas a successor of a language called ABC.  Guido remains Python'sprincipal author, although it includes many contributions from others.")
...
class MyDialog1(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.bnt_reset = wx.Button(self, -1, _("Reset Grid Entry"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Create DataBase"))
        self.SetSize((555, 444))
        ...
        self.grid_1.SetColLabelValue(1, _("Address"))
    ...
    def clk_remove_col(self, event):
        try:
            ...
            wx.MessageBox("You Did Not Select Any Row To Delete please select")
    ...
    def clk_Create_db(self, event):
        try:
            ...
            wx.MessageBox("The Grid Is Empty! Please Fill Grid")
        event.Skip()
    ...
    def clk_reset_grid(self, event):
        ...
        self.txtFileName.Value="python27"
        self.txtDataName.Value="python27"
        self.txtDataTable.Value="python27"
